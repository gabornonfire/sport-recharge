  ...
  return (
    <section id="idopontfoglalas" className="py-16 md:py-24 bg-dark-deepest">
      <div className="container max-w-2xl px-5 sm:px-6">
        ...
        <div className="mb-5 md:mb-6 rounded-2xl border border-gold/20 bg-card/60 px-4 sm:px-5 py-3.5 sm:py-4 shadow-[0_8px_30px_rgba(0,0,0,0.08)]">
          <div className="flex items-start justify-center gap-2 text-foreground font-heading font-semibold text-center text-sm sm:text-base">
            <MapPin className="h-4 w-4 text-gold-light flex-shrink-0 mt-0.5" />
        ...
        <form onSubmit={handleSubmit} noValidate className="space-y-4 sm:space-y-5 p-4 sm:p-5 md:p-8 rounded-2xl bg-card border border-border shadow-[0_16px_48px_rgba(0,0,0,0.12)]">
          ...
          <Button
            ...
            className="w-full min-h-14 bg-primary hover:bg-primary/90 text-primary-foreground font-heading font-bold text-base sm:text-lg py-5 sm:py-6"
          >
